				...
				<form class="form-horizontal sub-content" role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
					...
					<div class="row">
						<div class="col form-group">
							...
							<textarea type="text" class="form-control" id="message" name="message" placeholder="How can we help you?"></textarea>
							<?php echo
					...
					<div class="row mt-2">
						<div class="col-6 form-group">
							...
							<div class="row">
								<input id="6_letters_code" class="form-control col" name="6_letters_code" type="text">
