<nav class="headnav navbar navbar-light bg-light py-4">
    <div class="container">
...
<nav class="topnav navbar navbar-expand-lg navbar-light bg-light d-none">
    <div></div>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <div class="navbar-nav text-center">
                <a class="nav-link <?php if ($nav == 'home') {
                                        echo 'active';
                                    } ?>" href="<?php echo $root ?>index.php">Home<span class="sr-only">(current)</span></a>
