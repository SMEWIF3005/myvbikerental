    ...
    <div class="row clearfix">
        <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="info-box-4 hover-zoom-effect">
                <div class="icon"> <i class="fas fa-user col-blue"></i> </div>
                <div class="content">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="info-box-4 hover-zoom-effect">
                <div class="icon"> <i class="fas fa-bug col-blush"></i> </div>
                <div class="content">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="info-box-4 hover-zoom-effect">
                <div class="icon"> <i class="fas fa-calendar-check col-cyan"></i> </div>
                <div class="content">
